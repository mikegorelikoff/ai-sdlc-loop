...
AI SDLC Loop is the focused delivery member of the AI SDLC product family. It installs 21 working `ai-sdlc-loop-{slug}` skills and one shared runtime while keeping specifications, approvals, repository-grounded quality reports, QA plans, evidence, and release decisions in deterministic local TOON artifacts.
...
Immutable `v0.1.1` retains its 17-member inventory; the v0.8.2
