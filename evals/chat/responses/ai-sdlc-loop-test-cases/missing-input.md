...
| Missing acceptance criterion | Why required | Known evidence | Options |
| --- | --- | --- | --- |
| Acceptance criterion | Determines test id | No supported assumption | Supply source / narrow requested scope |
