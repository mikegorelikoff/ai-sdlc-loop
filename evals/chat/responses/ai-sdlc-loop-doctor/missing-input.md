...
| Missing installation root | Why required | Known evidence | Options |
| --- | --- | --- | --- |
| Installation root | Determines check | No supported assumption | Supply source / narrow requested scope |
