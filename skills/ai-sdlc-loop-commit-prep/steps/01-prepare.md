# Prepare — ai-sdlc-loop-commit-prep: Commit Preparation
...
Inspect scope, current evidence and message readiness; only ai-sdlc-loop-commit owns commit execution after separate approval.
