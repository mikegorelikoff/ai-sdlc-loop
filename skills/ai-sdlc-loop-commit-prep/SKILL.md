...
# ai-sdlc-loop-commit-prep: Commit Preparation
...
- Skill name: `ai-sdlc-loop-commit-prep`
...
- S: interpret sources for Proposed path set, current Loop evidence, validated message and commit-owner handoff; cite unresolved decisions.
