---
name: ai-sdlc-loop-bug-hunter
description: Use after implementation or change when source and test evidence can support concrete defects; not speculative scenarios or missing requirements.
---
...
- Skill name: `ai-sdlc-loop-bug-hunter`
- Primary audience: QA, Dev
- Supporting audience: BA, Architecture, Delivery
- SDLC stage: Implementation defect discovery
- Purpose: Validate concrete implementation hypotheses and distinguish unsupported, reproduced and confirmed defects.
...
- Handoff: code review, implementation and verification; repairs require owning workflow authority.
...
Primary: ID / Severity / Location / Bug / Evidence / Decision status.
Secondary unverified candidates: Candidate / Location / Decision status / Next action.
