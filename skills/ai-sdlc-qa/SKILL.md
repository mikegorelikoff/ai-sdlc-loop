...
Route executable command selection to `ai-sdlc-validation`, scenario-to-test design to `ai-sdlc-test-cases`, security abuse coverage to `ai-sdlc-security-testing`, and final readiness evidence back to `ai-sdlc-verify`.
