# Execute — ai-sdlc-loop-code-review: Code Review
...
- Quick flow: `python3 skills/ai-sdlc-loop-code-review/scripts/review_readiness.py --quick-flow`
- Full flow with spec: `python3 skills/ai-sdlc-loop-code-review/scripts/review_readiness.py --full-flow --spec specs/<feature-name>`
...
10. Escalate to `$ai-sdlc-loop-security-testing` when exploitability, auth boundaries, secrets, or abuse paths are the primary concern.
