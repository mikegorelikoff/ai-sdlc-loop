...
# ai-sdlc-loop-code-review: Code Review
...
- Skill name: `ai-sdlc-loop-code-review`
...
- D: use [the owning Python entry point](scripts/review_readiness.py) with explicit inputs; success covers only executed checks.
- S: interpret sources for Findings-first review with severity, path, impact, fix, validation gaps, and residual risk; cite unresolved decisions.
