---
name: ai-sdlc-loop-edge-case-hunter
description: Use for boundary values, timing, ordering, partial failures and uncommon sequences around specified behavior; not missing product dimensions or confirmed code bugs.
---
...
- Skill name: `ai-sdlc-loop-edge-case-hunter`
- Primary audience: QA, Dev
- Supporting audience: BA, Architecture, Delivery
- SDLC stage: Boundary-condition discovery
- Purpose: Identify testable unusual conditions for evidenced capabilities without claiming a bug.
...
- Handoff: test-case design and QA; hypotheses do not authorize test or code changes.
...
Primary: ID / Edge case / Dimension / Impact / Expected behavior / Test mapping.
