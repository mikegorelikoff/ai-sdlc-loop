# Execute — ai-sdlc-loop-security-testing: Security Testing
...
- Quick flow analysis: `python3 skills/ai-sdlc-loop-security-testing/scripts/security_review_matrix.py --feature <feature-name> --quick-flow <input.md>...`
- Full flow analysis: `python3 skills/ai-sdlc-loop-security-testing/scripts/security_review_matrix.py --feature <feature-name> --full-flow <input.md>...`
