# Validate and Handoff — ai-sdlc-loop-approvals-sandbox: Approvals And Sandbox
...
- Do not decide which validation commands are required; use `$ai-sdlc-loop-validation`.
