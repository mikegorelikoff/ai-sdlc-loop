# Execute — ai-sdlc-loop-approvals-sandbox: Approvals And Sandbox
...
- Quick flow: `python3 skills/ai-sdlc-loop-approvals-sandbox/scripts/approval_plan.py --quick-flow --command "<command>" --justification "<user-facing question?>"`
- Full flow: `python3 skills/ai-sdlc-loop-approvals-sandbox/scripts/approval_plan.py --full-flow --command "<command>" --justification "<user-facing question?>" --prefix-rule "<safe reusable prefix>"`
...
5. Validate the approval plan before asking when time permits:
   ...
   ```bash
   python3 skills/ai-sdlc-loop-approvals-sandbox/scripts/approval_plan.py \
