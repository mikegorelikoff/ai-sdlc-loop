# Prepare — ai-sdlc-loop-branching: Branching
...
Do not use branch hygiene to define behavior or design. Use `ai-sdlc-loop-specify` for the change contract instead.
