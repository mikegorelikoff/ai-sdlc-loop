# Execute — ai-sdlc-loop-conventional-commit: Conventional Commit Message
...
- Quick flow: `python3 skills/ai-sdlc-loop-conventional-commit/scripts/validate_commit_msg.py --quick-flow --message "<type(scope): subject>"`
- Full flow: `python3 skills/ai-sdlc-loop-conventional-commit/scripts/validate_commit_msg.py --full-flow path/to/commit-message.txt`
...
9. Validate the message before committing:
   ...
   ```bash
   python3 skills/ai-sdlc-loop-conventional-commit/scripts/validate_commit_msg.py path/to/message.txt --require-traceability
   ```
