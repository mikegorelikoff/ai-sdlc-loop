# Execute — ai-sdlc-loop-validation: Validation Command Selection
...
- Quick flow: `python3 skills/ai-sdlc-loop-validation/scripts/validation_plan.py --quick-flow <changed-file>...`
- Full flow: `python3 skills/ai-sdlc-loop-validation/scripts/validation_plan.py --full-flow <changed-file>...`
...
- Run the validation planner when changed files are not trivial:
  ...
  ```bash
  python3 skills/ai-sdlc-loop-validation/scripts/validation_plan.py
  ```
