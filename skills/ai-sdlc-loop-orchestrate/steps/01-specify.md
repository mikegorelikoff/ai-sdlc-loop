...
Load `ai-sdlc-loop-sdd`, follow its manifest, and return its exact spec fingerprint for human review. `ai-sdlc-loop-specify` is retained for compatibility with existing callers.
