...
INTENT_RULES: tuple[tuple[str, tuple[str, ...], str, str, str], ...] = (
    ("commit", ("commit", "stage changes"), "implementation", "commit_prep", "ai-sdlc-loop-commit-prep"),
    ("security_review", ("security", "owasp", "authz", "abuse case"), "implementation", "security_testing", "ai-sdlc-loop-security-testing"),
    ...
    ("qa_planning", ("testability", "qa coverage", "test plan"), "refinement", "qa_gap_review", "ai-sdlc-loop-qa-requirements-gap-review"),
...
def discover_sources(root: Path, feature: str, explicit: Iterable[Path] = ()) -> tuple[str, ...]:
    root = root.resolve()
    mandatory = (
        root / "modules/core/module.toon", root / "config/ai-sdlc-loop-orchestrate.defaults.toon",
...
def build_card(
    *, root: Path, intent: str, feature: str, requested_rigor: str | None = None,
    ...
    if existing:
        ...
        workspace, stage, skill = "implementation", "branching", "ai-sdlc-loop-branching"
