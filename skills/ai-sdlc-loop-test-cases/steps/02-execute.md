# Execute — ai-sdlc-loop-test-cases: Test Cases For Implementation
...
- Quick flow analysis: `python3 skills/ai-sdlc-loop-test-cases/scripts/case_matrix.py --feature <feature-name> --quick-flow <input.md>...`
- Full flow analysis: `python3 skills/ai-sdlc-loop-test-cases/scripts/case_matrix.py --feature <feature-name> --full-flow <input.md>...`
