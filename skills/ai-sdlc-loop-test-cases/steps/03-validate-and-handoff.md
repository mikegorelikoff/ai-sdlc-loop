# Validate and Handoff — ai-sdlc-loop-test-cases: Test Cases For Implementation
...
- Do not claim verification signoff; use `ai-sdlc-loop-verify`.
- Do not choose final validation command execution; use `$ai-sdlc-loop-validation`.
- Do not implement production behavior from this skill alone; use `ai-sdlc-loop-specify`, explicit Implement approval, and approved scope.
